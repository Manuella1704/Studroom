...
from rooms.serializers import ChambreSerializer
...
def chat_ai(request):
    ...
    for chambre in chambres:
        training_rooms.append(
            ChambreSerializer(chambre).data
        )
    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "Tu es un assistant utile qui aide les étudiants à trouver des chambres. avec ces données : " +
                    str_training_rooms + "Si on te demande des chambre et que tu ne trouve pas dans cette liste dis juste que tu ne trouve pas de chambre."},
