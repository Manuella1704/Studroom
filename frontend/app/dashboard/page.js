      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        >
          ...
          <p className="text-gray-600 text-sm">
            Consulte les chambres que tu as ajoutées en favori pour mieux
            comparer.
          </p>
        </Link>
        ...
        >
          ...
          <p className="text-gray-600 text-sm">
            Tu quittes ton logement ? Publie une chambre pour aider un autre
            étudiant.
          </p>
        </Link>
        ...
        >
          ...
          <p className="text-gray-600 text-sm">
            Explorer d'autres annonces ou discuter avec l'assistant StudRoom.
          </p>
        </Link>
      </div>
    </div>
